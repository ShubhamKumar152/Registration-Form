...
radio_male=tk.Radiobutton(root, text='Male', variable=v, value='Male',bg='light green').grid(row=4,column=1)
...
def clicked():
    ...
    if tnc!=1:
        ...
        if name =='' or mail =='' or mob =='' or gend =='' or sub =='':
            ...
            msg = 'Registered'
            messageVar.config(text=msg,bg='green')
...
button = tk.Button(root, text='Cancel',height=1, width=10,bg='red', command=root.destroy)
